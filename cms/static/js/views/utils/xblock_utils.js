        ...
        deleteXBlock = function(xblockInfo, xblockType) {
            ...
            if (xblockInfo.get('is_prereq')) {
                ViewUtils.confirmThenRunOperation(
                    ...
                    interpolate(
                        gettext('Deleting this %(xblock_type)s is permanent and cannot be undone. Any content that has listed this content as a prerequisite will also have access limitations removed.'),
                        { xblock_type: xblockType },
                        true
                    ),
                    interpolate(
